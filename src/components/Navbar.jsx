...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between py-5 font-medium animate__animated animate__fadeInDown animate__slow	2s">
      <Link to="/">
      ...
      <div
        className={`absolute right-0 bottom-0 top-0 bg-white transition-all overflow-hidden ${
          visibel ? "w-full" : "w-0"
        }`}
      >
